...
# Enforce ownership/mode every boot — fixes drift if the file was
# created by a different code path or restored from a backup that
# didn't preserve perms.
chown root:git "$SSH_CLIENT_KEY_PATH" "$SSH_CLIENT_KEY_PATH.pub"
chmod 0640 "$SSH_CLIENT_KEY_PATH"
chmod 0644 "$SSH_CLIENT_KEY_PATH.pub"
